 ...
 * Usage: pnpm --filter @fms/orchestrator exec tsx scripts/run-think-tank.ts
 */
import { randomUUID } from "node:crypto";
import { mkdir, writeFile } from "node:fs/promises";
import { join } from "node:path";
import { ALL_AGENT_IDS } from "../../shared/src/constants.js";
import { runDebateWorkflow } from "../src/runners/workflow.js";
